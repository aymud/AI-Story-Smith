...
def create_story(
        ...
        response: Response,
        # Pulls the session ID and DB session using FastAPI’s dependency injection.
...
def generate_story_task(job_id: str, theme: str, session_id: str):
    # Need a new db session because this is a different thread and will run asynchronously.
    db = SessionLocal()
